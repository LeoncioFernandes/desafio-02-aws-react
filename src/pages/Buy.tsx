...
export default function Buy() {
  ...
  const checkout = () => {
    ...
    window.location.href = "/sucessfull"; // Redireciona para a página de sucesso
  };
  ...
  return (
    ...
    <div className="text-start bg-gray-200 rounded-md p-10 max-w-3xl">
      ...
      <input
        ...
        className="my-4 block p-3 border border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 sm:text-sm outline-none"
      />
      ...
      <input
        ...
        className="block w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 sm:text-sm outline-none"
      />
      ...
      <div className="grid grid-cols-[1fr_2fr] gap-4">
        <div>
          <input
            ...
            placeholder="Número"
            className="my-4 block w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 sm:text-sm outline-none"
          />
        </div>
  ...
  <div>
    <input
      ...
      placeholder="UF"
      className="block w-full p-3 border border-gray-300 rounded-md shadow-sm sm:text-sm text-center outline-none"
    /> 
  </div>
</div>
    </div>
  ...
  <div className="grid text-end gap-y-3">
    ...
    <p>R$ {deliveryFee}</p> {/*Valor aleatorio entre 3 e 30 */}
    <p><strong>R$ {(parseFloat(totalValue) + parseFloat(deliveryFee)).toFixed(2)}</strong></p>
  </div>
</div>
