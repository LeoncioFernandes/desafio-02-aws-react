      ...
      <section className="mb-60 max-w-3xl text-start bg-gray-200 rounded-md p-10 mt-3">
        ...
        <div className="flex justify-between mt-8">
          <button
            ...
            className={`flex items-center gap-3 w-full px-4 py-4 text-blackText text-center rounded-lg ${methodPayment === "Cartão de Crédito"
          ...
          <button
            ...
            className={`flex items-center gap-3 w-full px-4 py-4 text-blackText text-center rounded-lg ${methodPayment === "Cartão de Débito"
                ? "bg-secondary2 border-2 border-secondary"
                : "bg-gray-dark"
              } mx-2`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-3 w-full px-4 py-4 text-blackText text-center rounded-lg ${methodPayment === "Dinheiro"
                ? "bg-secondary2 border-2 border-secondary"
                : "bg-gray-dark"
              } ml-2`}
          >
